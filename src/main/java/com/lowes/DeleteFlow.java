...
public class DeleteFlow extends RouteBuilder {

	@Override
	public void configure() throws Exception {

		from("direct:MainRoute_Delete")
		.routeId("DeleteRouteName") // add route name
		.setProperty("RouteLoggerName").simple("${properties:R4.log4j.logger}")
		...
		.log(LoggingLevel.INFO, "{{R4.log4j.logger}}",
		...
		.log(org.apache.camel.LoggingLevel.INFO, "{{R1.log4j.logger}}",
